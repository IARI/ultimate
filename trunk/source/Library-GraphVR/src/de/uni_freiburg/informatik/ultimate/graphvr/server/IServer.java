...
public interface IServer {
	 ...
	 * 
	 * Data types must be registered with {@link #register(Class)} or {@link #register(Class, Consumer)} before they can
	 * be sent or requested.
	 * 
	 * @param type
	 */
	...
	/**
	 * registers a Data type with the Server with a Handler for incoming Data Objects of the type.
	 * 
	 * Data types must be registered with {@link #register(Class)} or {@link #register(Class, Consumer)} before they can
	 * be sent or requested.
	 * 
	 * @param type
	 * @param consumer
	 *            a consumer that will handle incoming data sent by the Client on it's own account - i.e. not in
